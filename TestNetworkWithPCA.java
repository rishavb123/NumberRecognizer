...
public class TestNetworkWithPCA {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        NeuralNetwork neuralNetwork = SerializableUtil.deserialize("mnist/network-pca.ser");
        PrincipalComponentAnalysis pca = SerializableUtil.deserialize("mnist/pca.ser");
        ...
        for(int i = 0; i < images.size(); i++)
        	dataSet.add(new DataPoint(pca.dimensionReduction(new Vector(images.get(i)), pca.defaultThreshold).toVector().getData(), labels.get(i)));
